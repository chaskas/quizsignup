CREATE TABLE alumno (id BIGINT AUTO_INCREMENT, user_id BIGINT UNIQUE NOT NULL, carrera_id BIGINT NOT NULL, matricula VARCHAR(10) NOT NULL, grupo_id BIGINT, INDEX user_id_idx (user_id), INDEX grupo_id_idx (grupo_id), INDEX carrera_id_idx (carrera_id), PRIMARY KEY(id)) ENGINE = INNODB;
